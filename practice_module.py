...
Part_0 = {
    ...
    'Q5' : (False, False, False, True, True),
    'Q6' : (True, True, True, True, True),
...
Part_1 = {
    ...
    'Q6' : (False, True, False, False, False),
    'Q7' : (False, False, True, False, False),
    'Q8' : (False, False, True, False, False),
    'Q9' : (True, False, False, False, False),
    'Q10': (False, False, True, False, False),
    'Q11': (False, False, True, True, False),
    'Q12': (True, False, False, False, False),
    'Q13': (False, True, False, False, False),
    'Q14': (False, True, False, False, False),
    'Q15': (False, False, False, True, False)
}
Part_3 = {
...
def form_creation(
    ...
    """
    Fungsi untuk menghasilkan form pertanyaan salah benar
    """
    # Tampilkan pertanyaan
    display(Markdown(f"### {judul}"))
    # Create checkbox widgets in a loop
    options_widgets = []
    for desc in option_descriptions:
        options_widgets.append(widgets.Checkbox(value=False, description=desc, layout=layouts))
    # Set tombol cek jawaban
    check_button = widgets.Button(description="Cek Jawaban")
    # Set area hasil pengecekan
    result = widgets.Textarea(value="", placeholder='Feedback', description='', disabled=True)
    # Set Jawaban berdasarkan opsi yang dipilih
    selected_options = tuple(options_widgets)
    # Set perilaku button saat diclick
    check_button.on_click(lambda event: check_answers(answers, selected_options, result))
    # Tampilkan semua ke layar using unpacking
    display(*options_widgets, check_button, result)
